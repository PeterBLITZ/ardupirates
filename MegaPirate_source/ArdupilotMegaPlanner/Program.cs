...
namespace ArdupilotMega
{
    static class Program
    {
        ...
        static void Application_ThreadException(object sender, System.Threading.ThreadExceptionEventArgs e)
        {
            ...
            if (e.Exception.GetType() == typeof(FileNotFoundException) || e.Exception.GetType() == typeof(BadImageFormatException)) // i get alow of error from people who click the exe from inside a zip file.
            {

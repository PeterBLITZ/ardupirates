...
namespace WebCamService
{
    ...
    public class Capture : ISampleGrabberCB, IDisposable
    {
        ...
        void timer1_Tick(object sender, EventArgs e)
        {
            ...
            catch { Console.WriteLine("Grab bmp failed"); System.Windows.Forms.MessageBox.Show("Problem with capture device, grabbing frame took longer than 5 sec"); this.CloseInterfaces(); }
        }

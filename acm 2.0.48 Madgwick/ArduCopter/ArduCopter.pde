...
#define THISFIRMWARE "MegaPirate NewLife V2.0.49 Madgwick"
/*
...
*/
        sin_pitch_y 	= sin(dcm.pitch);
	cos_pitch_x 	= cos(dcm.pitch);

	cos_roll_x 		= cos(dcm.roll);
	sin_roll_y 		= sin(dcm.roll);

	cos_yaw_x 		= cos(dcm.yaw);	// 0 x = north
	sin_yaw_y 		= sin(dcm.yaw);	// 1 y

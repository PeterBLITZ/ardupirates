...
/*
- ---------------------------------------------------------------------------- -
 HELICOPTER Example Trex 450 SETUP 
 - ---------------------------------------------------------------------------- -
*/
...
//#define AIRFRAME HELI   // You have an option of using an external gyro or not.
                          // You will have to start with heli default PID values.  See Heli.h
/*                        // See heli.h for more setup options.
- ---------------------------------------------------------------------------- -
 HELICOPTER Example Trex 450 SETUP - Pirates Version 
 - ---------------------------------------------------------------------------- -
*/
// Note: do not change AIRFRAME to HELI and then load it into a QUAD or you will end up with your engines going to 50% during the initialisation sequence
#define AIRFRAME HELICOPTER   // You will have to use and external gyro on your tail servo.  Connect Gyro to APM and Tail servo to Gyro.
                              // Default PID setting for quad can be a starting point for tunining.
/*                            // See heli.h for more setup options.
= ============================================================================ =
...
- ---------------------------------------------------------------------------- -
   ...
   NB! Not for Heli or Helicopter setup
- ---------------------------------------------------------------------------- -

...
static byte mapSwitch(int pulsewidth){
...
static byte readOptionSwitch(void){
	return mapSwitch(g.rc_7.radio_in);			// default for Arducopter
}
...
static void read_trim_switch()
{
	...
	if (g.rc_7.control_in > 800){
		...
		dcm.filter_result = readOptionSwitch();

...
void setup()
{
  ...
  motorCommand[0]=MIN_THROTTLE;  // Motors stoped
  motorCommand[1]=MIN_THROTTLE;
  motorCommand[2]=MIN_THROTTLE;
  motorCommand[3]=MIN_THROTTLE;
  motorCommand[4]=MIN_THROTTLE;
  motorCommand[5]=MIN_THROTTLE;
  motorCommand[6]=MIN_THROTTLE;
  motorCommand[7]=MIN_THROTTLE;
...
#endif
// FLIGHT_MODE_+
//      motorCommand[2] = constrain(ch_throttle - control_roll + control_yaw, minThrottle, 2000);
//      motorCommand[3] = constrain(ch_throttle + control_roll + control_yaw, minThrottle, 2000);
//      motorCommand[0] = constrain(ch_throttle + control_pitch - control_yaw, minThrottle, 2000);
//      motorCommand[1] = constrain(ch_throttle - control_pitch - control_yaw, minThrottle, 2000);

...
/*************************************************************/
/* CONTROL PARAMETERS FOR IR OBSTACLE AVOIDANCE (TEMPORAL) */

#define KP_RF_ROLL 0.06
#define KD_RF_ROLL 0.025
#define KI_RF_ROLL 0.00
#define KP_RF_PITCH 0.06 //0.065 //0.07 //0.1
#define KD_RF_PITCH 0.025  //0.03  //0.035 //0.05
#define KI_RF_PITCH 0.00 //0.01

#define RF_MAX_ANGLE 5  // Maximun command roll and pitch angle from obstacle avoiding control
/*************************************************************/

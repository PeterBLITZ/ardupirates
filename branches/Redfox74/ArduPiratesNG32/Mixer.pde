...
void matrix_debug()
{
  ...
  Serial3.println();
  Serial3.println("--------------------------");
  Serial3.println("        Motori Mixertable " );
  Serial3.println("--------------------------");
  Serial3.println();
  Serial3.println("--------------------------");
  Serial3.println("   Quad  Motor Debug     " );
  Serial3.println("--------------------------");

  Serial3.print("AIL:");
  Serial3.print(ch_roll);
  Serial3.print(" ELE:");
  Serial3.print(ch_pitch);
  Serial3.print(" THR:");
  Serial3.print( ch_throttle);
  Serial3.print(" YAW:");
  Serial3.print( ch_yaw);
  Serial3.print(" AUX:");
  Serial3.print(ch_aux);
  Serial3.print(" AUX2:");
  Serial3.print(ch_aux2);
  Serial3.println();
  Serial3.print("CONTROL_ROLL:");
  Serial3.print(control_roll);
  Serial3.print(" CONTROL_PITCH:");
  Serial3.print(control_pitch);
  Serial3.print(" CONTROL_YAW:");
  Serial3.print(control_yaw);
  Serial3.print(" SONAR_VALUE:");
  //  Serial3.print(sonar_value);
  //  Serial3.print(" TARGET_SONAR_VALUE:");
  //  Serial3.print(target_sonar_altitude);
  //  Serial3.print(" ERR_SONAR_VALUE:");
  //  Serial3.print(err_altitude);
  //  Serial3.println();
  //  Serial3.print("latitude:");
  //  Serial3.print(GPS_np.latitude);
  //  Serial3.print(" longitude:");
  //  Serial3.print(GPS_np.longitude);
  Serial3.print(" command gps roll:");
  Serial3.print(command_gps_roll);
  Serial3.print(" command gps pitch:");
  Serial3.print(command_gps_pitch);
  //  Serial3.print(" Lon_diff:");
  //  Serial3.print(Lon_diff);
  //  Serial3.print(" Lon_diff");
  //  Serial3.print(command_gps_pitch);
  Serial3.println();
  Serial3.print("AP MODE:");
  Serial3.print((int)AP_mode);
  Serial3.println();

#ifdef HEXARADIAL
  Serial3.println();
  Serial3.print((unsigned int)MotorI2C[5]);
  comma();
  Serial3.print((unsigned int)MotorI2C[0]);
  comma();
  Serial3.print((unsigned int)MotorI2C[1]);
  comma();
  Serial3.println();
  Serial3.print((unsigned int)MotorI2C[4]);
  comma();
  Serial3.print((unsigned int)MotorI2C[3]);
  comma();
  Serial3.println((unsigned int)MotorI2C[2]);
  Serial3.println("---------------");
  Serial3.println();
#endif

...
//  eeprom_checker = readEEPROM(eeprom_checker_ADR);
  ...
  CAM_SMOOTHING = readEEPROM (CAM_SMOOTHING_ADR);   
  CAM_SMOOTHING_ROLL = readEEPROM(CAM_SMOOTHING_ROLL_ADR); 
  CAM_CENT = readEEPROM(CAM_CENT_ADR);   
  CAM_FOCUS = readEEPROM(CAM_FOCUS_ADR);          
  CAM_TRIGGER = readEEPROM(CAM_TRIGGER_ADR);        
  CAM_RELEASE = readEEPROM(CAM_RELEASE_ADR);      
}

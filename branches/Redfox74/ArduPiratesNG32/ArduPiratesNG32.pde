...
AP_GPS_MTK16		gps;  // MediaTek-based GPS running the DIYDrones firmware 1.6
...
#ifdef SerXbee
  Serial3.begin(SerBau);
  Serial3.print("ArduPirate v");
  Serial3.println(VER);
  Serial3.println("You will find serial data on the Telemetry port.");
  Serial3.println("No commands or output on this serial port, check your Config.h if you need to change this.");
  Serial3.println();
#endif 
  SerPrln(VER);
  SerPrln("ArduPirate");

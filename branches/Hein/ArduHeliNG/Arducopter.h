...
//  Arrays for CCPM Conversion to Roll, Pitch & Collective
Vector3f ccpmValues;                // Array of ccpm input values
Vector3f rollPitchCollValues;       // Array containing deallocated roll, pitch and collective input commands

/// Array for sending values out to servos
Vector3f ccpmValues_out;            // Array of ccpm output values
Vector3f pitchRollCollValues_out;   // Array containing deallocated pitch, roll, and collective Output commands

...
void Matrix_update(void)
{
  ...
  Accel_Vector[0]=Accel_Vector[0]*0.4 + Sensor_Input[ACCEL_X]*0.6; // acc x
  Accel_Vector[1]=Accel_Vector[1]*0.4 + Sensor_Input[ACCEL_Y]*0.6; // acc y
  Accel_Vector[2]=Accel_Vector[2]*0.4 + Sensor_Input[ACCEL_Z]*0.6; // acc z

...
namespace ArdupilotMega
{
    public partial class MainV2 : Form
    {
        ...
        public static bool joystickenabled = false;
        ...
        private void MenuConnect_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Common.MessageShowAgain("Mavlink Connect","Make sure your APM slider switch is in Flight Mode (away from RC pins)");
                ...
                catch (Exception ex) { comPort.Close(); MessageBox.Show("Is your CLI switch in Flight position?\n(this is required for MAVlink comms)\n\n" + ex.ToString()); return; }
            }
        }
        ...
        private void xmlconfig(bool write)
        {
            ...
            else
            {
                ...
                catch (Exception) { } // bad config file
            }
        }
...
//                        Console.WriteLine(DateTime.Now.Millisecond);
                    ...
                    while (comPort.BytesToRead > 0 && givecomport == false)
                        comPort.readPacket();
                }

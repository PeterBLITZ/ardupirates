...
namespace ArdupilotMega.GCSViews
{
    partial class FlightData : UserControl
    {
        ...
        public FlightData()
        {
            ...
            CMB_modes.DataSource = Enum.GetNames(typeof(flightmodes));
        ...
        private void mainloop()
        {
            ...
            while (threadrun == 1)
            {
                ...
                if (!(lastdata.AddSeconds(8) > DateTime.Now) && comPort.IsOpen)
                {
                    ...
                    if (tracklast.AddSeconds(1) < DateTime.Now)
                    {
                        ...
                        if (CB_tuning.Checked == false) // draw if in view
                        {
                            ...
                            if (trackPoints.Count > 0)
                            {
                                ...
                                routes.Markers.Add(new GMapMarkerPlane(currentloc,(int)MainV2.cs.yaw));
        ...
        {
            MANUAL,
            //CIRCLE,	 // When flying sans GPS, and we loose the radio, just circle
            STABILIZE,
            ...
            RTL,
            LOITER,
            //TAKEOFF,	// This is not used by APM.  It appears here for consistency with ACM
            //LAND,		// This is not used by APM.  It appears here for consistency with ACM
            GUIDED
        }
    ...
    public class GMapMarkerPlane : GMapMarker
    {
        ...
        public GMapMarkerPlane(PointLatLng p, int heading)
            : base(p)
        {

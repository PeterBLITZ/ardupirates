/****************************************************************************** 
  ...
  THIS FILe HAS BEEN GENERATED BY THE ONLINE UNIVERSAL ARDU CONFIGURATOR 1.0  
                             Created by: Dani Saez       
 ****************************************************************************** 
 ...
 Author(s): ArduPirates deveopment team 
             Philipp Maloney, Norbert, Hein, Igor, Emile, Kim, DaniSaez 
...
= ============================================================================ = 
   ...
   helicopter. You will have to constantly correct its flight path to keep it 
   ...
   an ideal configuration you will only have to command it with your transmitter 
   when you want it to change its position in the air. Stability, horizontal 
...
- ---------------------------------------------------------------------------- - 
   TIP: Both can be used at the same time. It will automatically switch to BMP 
        if copter is above sonars MAX range. 
- ---------------------------------------------------------------------------- - 
                                                                              */ 
...
- ---------------------------------------------------------------------------- - 
   ...
   Uncomment this next line if you wish to use GPS, comment it if you do not want 
   to use GPS. 
                                                                              */ 
#define IsGPS 
...
/* 
   ...
   <a href=\"http://www.youtube.com/watch?v=-hm7wPb0ZEw\">http://www.youtube.com/watch?v=-hm7wPb0ZEw</a> 
                                                                              */ 
/* 
   SET MAGCALIBRATION: 
   ...
   Configurators artificial horizon. 
 
   Once you have achieved this fine tune in the Configurators serial monitor by 
   pressing \"T\" (capital t). 
                                                                              */ 
#define MAGCALIBRATION 4.2

/* SET MAGNETOMETER ORIENTATION: 
   Next, you will have to define how your magnetometer is mounted to your 
...
//#define MAGORIENTATION AP_COMPASS_COMPONENTS_UP_PINS_FORWARD_RIGHT // COMPONENTS_UP_PINS_FORWARD_RIGHT
//#define MAGORIENTATION AP_COMPASS_COMPONENTS_UP_PINS_RIGHT // COMPONENTS_UP_PINS_RIGHT
//#define MAGORIENTATION AP_COMPASS_COMPONENTS_UP_PINS_BACK_RIGHT // COMPONENTS_UP_PINS_BACK_RIGHT
//#define MAGORIENTATION AP_COMPASS_COMPONENTS_UP_PINS_BACK // COMPONENTS_UP_PINS_BACK
//#define MAGORIENTATION AP_COMPASS_COMPONENTS_UP_PINS_BACK_LEFT // COMPONENTS_UP_PINS_BACK_LEFT
//#define MAGORIENTATION AP_COMPASS_COMPONENTS_UP_PINS_LEFT // COMPONENTS_UP_PINS_LEFT
//#define MAGORIENTATION AP_COMPASS_COMPONENTS_UP_PINS_FORWARD_LEFT // COMPONENTS_UP_PINS_FORWARD_LEFT
//#define MAGORIENTATION AP_COMPASS_COMPONENTS_DOWN_PINS_FORWARD // COMPONENTS_DOWN_PINS_FORWARD
//#define MAGORIENTATION AP_COMPASS_COMPONENTS_DOWN_PINS_FORWARD_RIGHT // COMPONENTS_DOWN_PINS_FORWARD_RIGHT
//#define MAGORIENTATION AP_COMPASS_COMPONENTS_DOWN_PINS_RIGHT // COMPONENTS_DOWN_PINS_RIGHT
//#define MAGORIENTATION AP_COMPASS_COMPONENTS_DOWN_PINS_BACK_RIGHT // COMPONENTS_DOWN_PINS_BACK_RIGHT
//#define MAGORIENTATION AP_COMPASS_COMPONENTS_DOWN_PINS_BACK // COMPONENTS_DOWN_PINS_BACK
//#define MAGORIENTATION AP_COMPASS_COMPONENTS_DOWN_PINS_BACK_LEFT // COMPONENTS_DOWN_PINS_BACK_LEFT
//#define MAGORIENTATION AP_COMPASS_COMPONENTS_DOWN_PINS_LEFT // COMPONENTS_DOWN_PINS_LEFT
//#define MAGORIENTATION AP_COMPASS_COMPONENTS_DOWN_PINS_FORWARD_LEFT // COMPONENTS_DOWN_PINS_FORWARD_LEFT

/*   Sparkfun magnetometer;                                                   */
#define MAGORIENTATION AP_COMPASS_SPARKFUN_COMPONENTS_UP_PINS_FORWARD

//#define MAGORIENTATION AP_COMPASS_SPARKFUN_COMPONENTS_UP_PINS_FORWARD_RIGHT // COMPONENTS_UP_PINS_FORWARD_RIGHT
//#define MAGORIENTATION AP_COMPASS_SPARKFUN_COMPONENTS_UP_PINS_RIGHT // COMPONENTS_UP_PINS_RIGHT
//#define MAGORIENTATION AP_COMPASS_SPARKFUN_COMPONENTS_UP_PINS_BACK_RIGHT // COMPONENTS_UP_PINS_BACK_RIGHT
//#define MAGORIENTATION AP_COMPASS_SPARKFUN_COMPONENTS_UP_PINS_BACK // COMPONENTS_UP_PINS_BACK
//#define MAGORIENTATION AP_COMPASS_SPARKFUN_COMPONENTS_UP_PINS_BACK_LEFT // COMPONENTS_UP_PINS_BACK_LEFT
//#define MAGORIENTATION AP_COMPASS_SPARKFUN_COMPONENTS_UP_PINS_LEFT // COMPONENTS_UP_PINS_LEFT
//#define MAGORIENTATION AP_COMPASS_SPARKFUN_COMPONENTS_UP_PINS_FORWARD_LEFT // COMPONENTS_UP_PINS_FORWARD_LEFT
//#define MAGORIENTATION AP_COMPASS_SPARKFUN_COMPONENTS_DOWN_PINS_FORWARD // COMPONENTS_DOWN_PINS_FORWARD
//#define MAGORIENTATION AP_COMPASS_SPARKFUN_COMPONENTS_DOWN_PINS_FORWARD_RIGHT // COMPONENTS_DOWN_PINS_FORWARD_RIGHT
//#define MAGORIENTATION AP_COMPASS_SPARKFUN_COMPONENTS_DOWN_PINS_RIGHT // COMPONENTS_DOWN_PINS_RIGHT
//#define MAGORIENTATION AP_COMPASS_SPARKFUN_COMPONENTS_DOWN_PINS_BACK_RIGHT // COMPONENTS_DOWN_PINS_BACK_RIGHT
//#define MAGORIENTATION AP_COMPASS_SPARKFUN_COMPONENTS_DOWN_PINS_BACK // COMPONENTS_DOWN_PINS_BACK
//#define MAGORIENTATION AP_COMPASS_SPARKFUN_COMPONENTS_DOWN_PINS_BACK_LEFT // COMPONENTS_DOWN_PINS_BACK_LEFT
//#define MAGORIENTATION AP_COMPASS_SPARKFUN_COMPONENTS_DOWN_PINS_LEFT // COMPONENTS_DOWN_PINS_LEFT
//#define MAGORIENTATION AP_COMPASS_SPARKFUN_COMPONENTS_DOWN_PINS_FORWARD_LEFT // COMPONENTS_DOWN_PINS_FORWARD_LEFT
#endif 
/*  
= ============================================================================ = 
...
- ---------------------------------------------------------------------------- - 
   Function for: Motormount LEDs or Attraction Mode 
- ---------------------------------------------------------------------------- - 
                                                                              */ 
//#define IsAM             // Do we have motormount LEDs. AM = Atraction Mode 
...
- ---------------------------------------------------------------------------- - 
   ...
   the multicopters position in the air (also called attitude). 
...
#define CAM_TILT_CH    6       // Channel for radio knob to control tilt 
...
- ---------------------------------------------------------------------------- - 
   ...
   http://code.google.com/p/ardupirates/wiki/BatteryAlarmHowto 
                                                                              */ 
#define BATTERY_EVENT  0  // Do we have battery alarm wired up? 1 = yes, 0 = no 
#define LOW_VOLTAGE 11.4 // Pack voltage at which to trigger alarm (Set to about 1 volt above ESC low voltage cutoff) 
